...
export function parseBalanceSheet(raw) {
  ...
  for (const r of allRows) {
    ...
    // ✅ ✅ ✅ ONLY CHANGE MADE (THIS IS YOUR REQUIREMENT)
    if (name.includes('total for current liabilities')) {
      base = value;
      console.log('✅ FOUND TOTAL CURRENT LIABILITIES:', name, value);
    }

    // EXISTING LOGIC (LEFT INTACT)
