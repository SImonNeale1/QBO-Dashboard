...
export function parseBalanceSheet(raw) {
  ...
  /*
   * Always calculate the balance-sheet totals from their
   * individual components.
   *
   * QuickBooks section summaries can include nested rows or
   * intermediate totals, so they must not be trusted for these
