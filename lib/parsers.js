...
export function parseBalanceSheet(raw) {
  const result = {
    ...
    currentAssets: 0,
    fixedAssets: 0,
    foundFixedAssetsSection: false, // ✅ NEW FIX
    depreciation: 0,
    totalAssets: 0,
  ...
  for (const row of raw.Rows?.Row || []) {
    ...
    // ✅ FIXED ASSETS (USE QBO VALUE ONLY)
      ...
      result.foundFixedAssetsSection = true; // ✅ CRITICAL
